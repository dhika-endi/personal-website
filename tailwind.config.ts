...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        "bg-left":    "var(--bg-left)",
        "bg-right":   "var(--bg-right)",
        "ink-dark":   "var(--ink-dark)",
        "ink-dark2":  "var(--ink-dark2)",
        "ink-dark3":  "var(--ink-dark3)",
      ...
      boxShadow: {
        glass: "0 0 0 1px hsla(0, 0%, 100%, 0.03) inset, 0 4px 24px -4px hsla(0, 0%, 0%, 0.4)",
        "glass-elevated": "0 0 0 1px hsla(0, 0%, 100%, 0.05) inset, 0 8px 32px -8px hsla(0, 0%, 0%, 0.5)",
